			...
			<?php
				...
				$gapi_key = "1ujgVtqqMRE0Z9Z7";
				$gsecret_key = "pdfoQ2YvxvotJStD6poxzsczICfCWtHk" ;
				...
				function getNewAdress($api_key,$secret_key )
				{
					...
					$vdump= getBalance($api_key,$secret_key );
					$principal_account =$vdump["id"];
					...
					$data = $stime."POST"."/v2/accounts/".$principal_account."/addresses".$post_array;
					...
					$adr = json_decode($return,true)["data"]["address"];
					echo curl_error ( $curl );
					curl_close($curl);
					return $adr ;
