...
include("classes/BaseHelper.php");
...
if (! isset ( $_COOKIE ["coinCasino"] )) {
	...
	$myQuery = "insert into cc_session values(:SESSION_ID,:BTC_ADRESS,:ETH_ADRESS,:SYS_DATE,:STATUS,:GP);";
...
<link
	href="/ajax/libs/font-awesome/4.6.3/css/font-awesome.css"
	rel="stylesheet" />
															...
															<tr>
																...
																<td valign="top" width="546">
																	<div style="">
																		...
																		<span id="lblBalance" style="font-size: 15px">Credit : 5$&nbsp;&nbsp;&nbsp;User :<?php echo $sess_id ; ?></span>
...
var coin = "BTC";
	...
	<div background="images/stripe2.png" style="z-index:99;bottom:0px;left:0px;position:absolute;background-repeat:repeat"
